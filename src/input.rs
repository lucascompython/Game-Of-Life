...
fn setup(mut commands: Commands) {
    commands
        .spawn_bundle(Camera2dBundle::default()) //TODO CHECK THIS https://docs.rs/bevy/latest/bevy/render/camera/struct.OrthographicProjection.html && https://github.com/bevyengine/bevy/blob/main/examples/3d/orthographic.rs
        .insert(MainCamera)
        .insert(Movement {
